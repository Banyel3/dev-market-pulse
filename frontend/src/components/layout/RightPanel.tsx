...
const RightPanel = () => {
  ...
  const displayedSkills = showAllSkills ? skills : skills.slice(0, 7);
        ...
        <div className="space-y-4">
          <div className="p-4 bg-green-50 rounded-xl border border-green-100">
            ...
            <p className="text-xs text-gray-600 mt-1">
              Demand up 24% this week in FinTech sector.
            </p>
          </div>
          ...
          <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
            ...
            <p className="text-xs text-gray-600 mt-1">
              Highest volume of new startup roles posted.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {displayedSkills.map((skill) => (
            <span
              key={skill}
              className="px-3 py-1.5 bg-gray-50 text-gray-600 text-xs font-medium rounded-lg hover:bg-gray-100 cursor-pointer transition-colors"
            >
              {skill}
            </span>
          ))}
